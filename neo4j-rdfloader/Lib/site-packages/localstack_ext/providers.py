...
def awslambda_legacy():from localstack.services.awslambda import lambda_starter as A;from localstack_ext.services.awslambda.legacy.lambda_extended import LambdaExtLifecycleHook as B,LambdaService as C,patch_lambda as D;D();return C(_A,start=A.start_lambda,stop=A.stop_lambda,check=A.check_lambda,lifecycle_hook=B())
@pro_aws_provider(api=_A,name=_C)
def awslambda_v1():from localstack.services.awslambda import lambda_starter as A;from localstack_ext.services.awslambda.legacy.lambda_extended import LambdaExtLifecycleHook as B,LambdaService as C,patch_lambda as D;D();return C(_A,start=A.start_lambda,stop=A.stop_lambda,check=A.check_lambda,lifecycle_hook=B())
@pro_aws_provider(api=_A,name=_E)
def awslambda_asf():from localstack_ext.services.awslambda.provider import LambdaProviderPro as A;B=A();return Service.for_provider(B)
@pro_aws_provider(api=_A,name=_F)
def awslambda_v2():from localstack_ext.services.awslambda.provider import LambdaProviderPro as A;B=A();return Service.for_provider(B)
@pro_aws_provider(api=_A)
def awslambda():from localstack_ext.services.awslambda.provider import LambdaProviderPro as A;B=A();return Service.for_provider(B)
@pro_aws_provider()
...
def s3_legacy():from localstack.services.s3 import s3_listener as B,s3_starter as A;from localstack_ext.services.s3 import s3_extended as C;C.patch_s3();return Service(_B,listener=B.UPDATE_S3,start=A.start_s3,check=A.check_s3)
